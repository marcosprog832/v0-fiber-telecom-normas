    ...
    <section className="pt-20 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#00f2ff]/10 border border-[#00f2ff]/20 px-3 sm:px-4 py-2 rounded-full mb-6 sm:mb-8">
              <Zap size={16} className="text-[#00f2ff]" />
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-[#00f2ff]">
                Inscrições Abertas 2026
              </span>
            </div>

            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black leading-tight mb-6 tracking-tight">
              DOMINE AS NORMAS DA
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10 sm:mb-12">
              <a
                ...
                className="group px-6 sm:px-8 py-3 sm:py-4 bg-[#00f2ff] text-[#02040a] font-bold rounded-lg hover:bg-[#00d4e6] transition-all flex items-center justify-center gap-3 shadow-[0_0_30px_rgba(0,242,255,0.3)] text-sm sm:text-base"
              >
                COMEÇAR AGORA
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                <div key={idx} className="text-center lg:text-left">
                  <div className="text-2xl sm:text-3xl font-black text-[#00f2ff] mb-1">{stat.value}</div>
            ...
            <div className="relative aspect-[3/4] max-w-sm sm:max-w-md mx-auto">
              ...
              <div className="relative h-full rounded-3xl overflow-hidden bg-gradient-to-b from-[#0a1520] to-[#02040a]">
                <img
                  ...
                  className="absolute bottom-0 left-1/2 -translate-x-1/2 h-[85%] sm:h-[90%] w-auto object-contain object-bottom"
                />
                {/* Natural Fade */}
              ...
              {/* Decorative Elements */}
              <div className="absolute -bottom-4 -right-4 w-24 sm:w-32 h-24 sm:h-32 border-4 border-[#00f2ff]/20 rounded-full"></div>
              <div className="absolute top-8 sm:top-10 -left-3 sm:-left-4 w-3 sm:w-4 h-3 sm:h-4 bg-[#00f2ff] rounded-full animate-pulse"></div>
            </div>
          </motion.div>
        </div>
      </div>
